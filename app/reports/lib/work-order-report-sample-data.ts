...
export const SAMPLE_WORK_ORDER_ROWS: SampleWorkOrderRow[] = [
  {
    ...
    description: "Guest reports the room is not cooling.",
    area: "Room 204",
    areaId: null,
    category: "HVAC",
    itemIssue: "AC / HVAC",
  ...
  },
  {
    ...
    description: "Lobby fixture is no longer working.",
    area: "Main Lobby",
    areaId: null,
    category: "Electrical",
    itemIssue: "Light",
    ...
    resolution: "Fixture replaced and tested.",
    daysOpen: 2,
    hoursOpen: 55,
  },
  {
    ...
    description: "Pool pump is vibrating during operation.",
    area: "Pool Deck",
    areaId: null,
    ...
    resolution: "Bearing assembly adjusted.",
    daysOpen: 1,
    hoursOpen: 28,
  },
  {
    ...
    description: "Sink is leaking and draining slowly.",
    area: "Room 312",
    areaId: null,
    category: "Plumbing",
    itemIssue: "Sink",
  ...
  },
  {
    ...
    description: "Bracket is loose from the wall.",
    area: "Boiler Room",
    areaId: null,
    category: "Fire & Life Safety",
    itemIssue: "Fire / Life Safety",
    priority: "Important",
    status: "Completed",
    createdBy: "R. Patel",
    ...
    resolution: "Re-secured to wall anchor.",
    daysOpen: 1,
    hoursOpen: 18,
  },
];
