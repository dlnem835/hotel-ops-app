...
export const SHIPPING_TIMELINE_EVENTS = {
  ...
  trackingUpdateReceived: "tracking_update_received",
  trackingUpdateIgnoredStale: "tracking_update_ignored_stale",
  shippingException: "shipping_exception",
...
export const SHIPPING_TIMELINE_LABELS: Record<ShippingTimelineEventType, string> = {
  ...
  tracking_update_received: "Tracking update received",
  tracking_update_ignored_stale: "Stale tracking update ignored",
