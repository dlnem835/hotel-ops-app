...
import { markShippingLabelPrinted } from "@/app/lib/lost-found-shipping/shipping-requests";
import {
...
/** Staff-only: mark automated shipping label as printed. */
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const result = await markShippingLabelPrinted(
      supabase,
