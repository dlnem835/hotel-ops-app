...
import { reactivateAdminOrganization } from "@/app/lib/platform-admin/server/organization-lifecycle";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const organization = await reactivateAdminOrganization(supabase, user.id, organizationId);
